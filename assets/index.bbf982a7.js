...
async function z(b) {
  ...
  try {
    ...
    return console.log("Error Fetching"), !1;
  }
  var a = await u.json();
  return a.valid === !0;
}
...
function q(b) {
  ...
  const a = v.querySelector(":not([data-letter])");
...
function ub(b, u) {
  ...
  v.querySelectorAll(":not([data-letter])").length == 0 &&
    (y(t.join("")),
    (a.status = "Lose"),
    m(),
    x("lose"),
...
`,
  g = () => v.querySelectorAll('[data-state="active"]'),
  B = document.querySelector(".keyboard"),
  v = document.querySelector(".gamegrid");
async function ob() {
  if (
    (await $(),
    (t = F()),
        ...
        b.gameState.forEach(async (a, d) => {
          b.gameState[d] !== "" &&
            b.gameState[d].forEach(async (c, f) => {
              var e = v.querySelector(":not([data-letter])");
              (e.dataset.letter = c),
                await L(100 * (f + 1)),
